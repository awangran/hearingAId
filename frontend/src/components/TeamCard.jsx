  ...
  export function TeamSection12() {
    return (
      ...
      <div className="container mx-auto">
        ...
        <div className="mb-16 mt-16 text-center lg:mb-28">
          <Typography
            variant="h1"
            color="blue-gray"
            className="my-2 !text-2xl lg:!text-4xl"
